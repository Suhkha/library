              ...
              <div class="flex flex-col">
                ...
                <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                  <div class="align-middle inline-block min-w-full overflow-hidden border-b border-gray-200">
                    <form id="validate_form" class="w-full px-8 m-auto" method="POST" action="/panel/authors/save">
                      @csrf
                      <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3 mb-6 md:mb-0">
                          ...
                          <input required class="form-control appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="Arthur Conan Doyle" name="name">
                        </div>
                      </div>
                      <div class="flex flex-wrap -mx-3 mb-6">
