        ...
        <div class="md:w-3/4 md:mx-auto">
            ...
            <div class="flex flex-col">
              <div class="font-semibold bg-blue-900 text-white py-3 px-6 mb-8">
                ...
                <a href="{{ url('panel/books/new') }}" class="text-sm hover:bg-white hover:text-blue-900 border py-2 px-2 float-left lg:float-right cursor-pointer block lg:inline-block">New book</a>
              </div>
