            ...
            <div class="flex flex-col">
              ...
              <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                <div class="align-middle inline-block min-w-full overflow-hidden border-b border-gray-200">
                  <form id="validate_form" class="w-full px-8 m-auto" method="POST" action={{ route('panel.books.update', ['id' => $book->id]) }}>
                    @csrf
                    <div class="flex flex-wrap -mx-3 mb-6">
                      ...
                      <input required class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="Harry Potter" name="name" value="{{ $book->name }}">
                      </div>
                    </div>
                      ...
                      <div class="w-full px-3">
                        ...
                        <div class="inline-block relative w-64">
                          <select required class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="authors" name="author_id">
                            <option value="{{ $current_author->id }}">{{ $current_author->name }}</option>
                      ...
                      <div class="w-full px-3">
                        ...
                        <div class="mt-2">
                          <label class="block items-center">
                            <input type="date" required class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="published_date" value="{{ $book->published_date }}">
                          </label>
                        </div>
                      </div>
                    </div>
