                    ...
                    <form id="validate_form" class="w-full px-8 m-auto" method="POST" action="/panel/categories/save">
                      ...
                      <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                          ...
                          <textarea required class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="description" type="text" placeholder="" name="description"></textarea>
                        </div>
                      </div>
                      <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
